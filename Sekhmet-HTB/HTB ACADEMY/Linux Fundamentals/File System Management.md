...
```shell-session
SekhmetCyka@htb[/htb]$ sudo fdisk -l
...
```shell-session
SekhmetCyka@htb[/htb]$ cat /etc/fstab
...
```shell-session
SekhmetCyka@htb[/htb]$ sudo mount /dev/sdb1 /mnt/usb
SekhmetCyka@htb[/htb]$ cd /mnt/usb && ls -l
...
```shell-session
SekhmetCyka@htb[/htb]$ sudo umount /mnt/usb
```
