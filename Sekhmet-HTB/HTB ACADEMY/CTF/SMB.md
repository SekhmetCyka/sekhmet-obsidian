...
```shell-session
SekhmetCyka@htb[/htb]$ nmap --script smb-os-discovery.nse -p445 10.10.10.40
...
```shell-session
SekhmetCyka@htb[/htb]$ nmap -A -p445 10.129.42.253
...
```shell-session
SekhmetCyka@htb[/htb]$ smbclient -N -L \\\\10.129.42.253
...
```shell-session
SekhmetCyka@htb[/htb]$ smbclient \\\\10.129.42.253\\users
...
```shell-session
SekhmetCyka@htb[/htb]$ smbclient -U bob \\\\10.129.42.253\\users
...
```shell-session
SekhmetCyka@htb[/htb]$ snmpwalk -v 2c -c public 10.129.42.253 1.3.6.1.2.1.1.5.0
...
```shell-session
SekhmetCyka@htb[/htb]$ snmpwalk -v 2c -c private  10.129.42.253 
...
```shell-session
SekhmetCyka@htb[/htb]$ onesixtyone -c dict.txt 10.129.42.254
